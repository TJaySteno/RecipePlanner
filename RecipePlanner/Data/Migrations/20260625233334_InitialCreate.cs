        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CoolTimeInMinutes = table.Column<int>(type: "int", nullable: false),
                    Servings = table.Column<int>(type: "int", nullable: false),
                    Calories = table.Column<int>(type: "int", nullable: false),
                    ProteinInGrams = table.Column<int>(type: "int", nullable: false),
                    CarbsInGrams = table.Column<int>(type: "int", nullable: false),
                    FatInGrams = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
